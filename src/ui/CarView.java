...
public class CarView extends JPanel {
	...
	private void paintCar(Graphics g) {
		...
		g.drawPolyline(xPoints3, yPoints3, xPoints3.length);

		// Roue avant droite
		int xPoints4[] = {150, 155, 155, 150};
		int yPoints4[] = {80, 80, 40, 40};
		g.drawPolyline(xPoints4, yPoints4, xPoints4.length);

		// Roue arrière gauche
		int xPoints5[] = {10, 5, 5, 10};
		int yPoints5[] = {240, 240, 200, 200};
		g.drawPolyline(xPoints5, yPoints5, xPoints5.length);

		// Roue arrière droite
		int xPoints6[] = {150, 155, 155, 150};
		int yPoints6[] = {240, 240, 200, 200};
		g.drawPolyline(xPoints6, yPoints6, xPoints6.length);
	}
